...
<script type="text/javascript">
	...
	function changeLogin(){
		...
		var newUserId = '<label>手机号:</label> <input type="text" class="form-control"\n' +
				'\t\t\t\t\tname="userAccount" value="${USER_INFO.userAccount }" placeholder="请输入您的手机号" required autofocus >';
		userId.innerHTML=newUserId;

		var newUserPassword = '<div id="passwordID" class="form-group login-text" style="text-align: left;">\n' +
				'\t\t\t\t<label>验证码:</label> <input type="password"\n' +
				'\t\t\t\t\tclass="form-control" name="userPass" value="${USER_INFO.userPass }" placeholder="请输入您的验证码" required >';
        var newVerifyCode = '<label>验证码:&nbsp;</label><input class="form-control login-inputcode"\n' +
				'\t\t\t\t\ttype="text" name="codetext" onblur="check()" id="codeInput" />&nbsp;&nbsp;&nbsp;<button type="button" onclick="getVerifyCode()"> 获取验证码</button> '
