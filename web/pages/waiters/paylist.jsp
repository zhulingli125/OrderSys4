...
<%--	<script type="text/javascript" src="bootstrap/js/jquery.min.js"></script>--%>
	<script type="text/javascript" src="bootstrap/js/jquery.qrcode.min.js"></script>
...
<script type="text/javascript">
	...
	function showList(responseXml, obj) {
		...
		for ( var i = 0; i < orders.length; i++) {
			...
			newLine += "<td><a  style='width:450px' onclick='pay("
					+ orderId + ",this)'>买单</a>";
			newLine += "</td></tr>";
	...
	function  qrcode() {
		var popBox = document.getElementById("qrcode123");
		popBox.style.display = "block";
		$("#qrcode123").qrcode({width:200,heigth:200,text:"welcome"})
	}
	...
	function payCallback(responseTxt, obj) {
		...
		var popBox = document.getElementById("qrcode123");
		popBox.innerHTML=""
		 // popBox.parentElement.removeChild(popBox);
