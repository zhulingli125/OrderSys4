...
public class UploadServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 进行Http请求解析，将参数解析的结果存入com.chinasofti.com.chinasofti.util.web.upload.SubmitInformation类的对象中
		SubmitInformation info = (SubmitInformation) parser.parse(request,
				"com.chinasofti.com.chinasofti.util.web.upload.SubmitInformation");
